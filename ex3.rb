...
channel.queue("us.california").bind(exchange, routing_key: 'americas.south.#').subscribe do |delivery_info, metadata, payload|
	puts "An update for South America: #{payload}, routing key is #{delivery_info.routing_key}"
end
...
exchange.publish("Sand Diego update", routing_key: "americas.north.us.ca.sandiego").
